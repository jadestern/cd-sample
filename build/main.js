...
module.exports = {
  ...
  */
  head: {
    title: '테라펀딩 대출자',
    meta: [{ charset: 'utf-8' }, { name: 'viewport', content: 'width=device-width, initial-scale=1' }, { hid: 'description', name: 'description', content: '테라펀딩 대출자 플랫폼' }],
    link: [{ rel: 'icon', type: 'image/x-icon', href: '/favicon.ico' }, { rel: 'stylesheet', href: '//cdn.rawgit.com/moonspam/NanumSquare/master/nanumsquare.css' }]
  },
  /*
